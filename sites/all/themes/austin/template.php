...
function austin_theme() {
  ...
  $items['comment'] = array(
    ...
    'template' => 'object',
    'path' => drupal_get_path('theme', 'austin') .'/templates',
  );
  $items['node'] = array(
 ...
 */
function austin_preprocess_html(&$vars) {
  $vars['classes_array'][] = 'austin';
}

/**
 * Implementation of preprocess_page().
 */
function austin_preprocess_page(&$vars) {
 ...
 */
function austin_preprocess_block(&$vars) {
  $vars['hook'] = 'block';
 ...
 */
function austin_preprocess_node(&$vars) {
  $vars['hook'] = 'node';
 ...
 */
function austin_preprocess_comment(&$vars) {
  $vars['hook'] = 'comment';
 ...
 */
function austin_preprocess_fieldset(&$vars) {
 ...
 */
function austin_preprocess_field(&$vars) {
 ...
 */
function austin_textarea($variables) {
 ...
 */
function austin_pager_list($vars) {
  $tags = $vars['tags'];
  $element = $vars['element'];
  $parameters = $vars['parameters'];
  $quantity = $vars['quantity'];
 ...
 */
function austin_pager_link($vars) {
  $text = $vars['text'];
 ...
 */
function austin_views_mini_pager($vars) {
  $tags = $vars['tags'];
  $quantity = $vars['quantity'];
  $element = $vars['element'];
  $parameters = $vars['parameters'];
